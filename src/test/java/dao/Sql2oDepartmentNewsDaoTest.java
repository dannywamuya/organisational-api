...
public class Sql2oDepartmentNewsDaoTest {
    ...
    public void addingNewsSetsId() throws Exception {
        ...
        assertEquals(1, departmentNewsDao.getAll(departmentId).get(0).getId());
    }
    ...
    public void addedNewsIsReturnedFromGetAll() throws Exception {
        ...
        assertEquals(1, departmentNewsDao.getAll(departmentId).size());
    }
    ...
    public void noNewsReturnsEmptyList() throws Exception {
        ...
        assertEquals(0, departmentNewsDao.getAll(departmentId).size());
    }
    ...
    public void deleteByIdDeletesCorrectNews() throws Exception {
        ...
        assertEquals(1, departmentNewsDao.getAll(otherNews.getDepartmentId()).size());
        assertEquals(0, departmentNewsDao.getAll(news.getDepartmentId()).size());
    }
